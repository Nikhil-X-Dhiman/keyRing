...
export const ListItem = ({
	...
	const listStyle = `hover:bg-slate-700 pl-2 py-2 flex items-center pr-3 justify-between gap-x-1 border-l-4  active:border-l-slate-400 cursor-pointer truncate`;
